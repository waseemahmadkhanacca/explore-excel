...
mistakes:
  ...
  - level: error
    ...
    body: IFS arrived in Excel 2019. Earlier versions return #NAME?. Nested IF works everywhere, which is still a reason to use it for files that leave your organisation.
  - level: warning
