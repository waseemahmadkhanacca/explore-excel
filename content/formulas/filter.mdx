...
mistakes:
  - level: error
    ...
    body: FILTER returns #NAME? in Excel 2019 and earlier. It is a dynamic array function and there is no fallback that behaves the same way. For files that leave your organisation, this is the deciding factor.
  - level: error
