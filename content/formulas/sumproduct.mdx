...
mistakes:
  - level: error
    ...
    body: Every array must have identical dimensions. B2:B7 with C2:C8 returns #VALUE!. Unlike SUMIFS, there is no forgiving behaviour at all — the arrays are multiplied position by position.
  - level: warning
