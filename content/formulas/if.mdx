...
mistakes:
  ...
  - level: warning
    ...
    body: The = comparison ignores case, so "north" equals "North". If case genuinely matters, use EXACT. Most of the time the case-insensitive behavior is what you want, but it can hide duplicates you needed to spot.
faq:
