...
mistakes:
  ...
  - level: warning
    ...
    body: DATEDIF does not appear in the function list and shows no argument tooltip as you type. It still calculates correctly. The absence is a documentation decision by Microsoft, not a sign it is deprecated in behavior.
  - level: warning
