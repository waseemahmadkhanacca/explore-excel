...
mistakes:
  - level: error
    ...
    body: SUBSTITUTE("North","north","South") changes nothing, because the case does not match. REPLACE is not an alternative — it works on positions rather than content. To ignore case you have to normalize with UPPER or LOWER first.
  - level: warning
