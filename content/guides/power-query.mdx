...
It is built into Excel from 2016 onwards, under Data, then Get Data. No installation, no license, no VBA.
...
Macros solve the first two and introduce their own problems: they break when Excel updates, they need a macro-enabled file that many organizations block by email, and almost nobody can read someone else's VBA.
