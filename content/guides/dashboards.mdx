...
Pick one accent color and one neutral. Use the accent for the thing you want noticed and the neutral for everything else.

Dashboards with eight colors are asking the reader to work out what the colors mean. Dashboards with one accent are telling them where to look.
