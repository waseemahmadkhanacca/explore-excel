...
They break sorting, break filtering, break `Ctrl` plus arrow navigation, break PivotTables, and make ranges behave unpredictably in formulas. Centre Across Selection gives the same appearance with none of the damage. It sits in the Format Cells dialog under Horizontal alignment.
