...
description: Merged cells break sorting, filtering, navigation and PivotTables. Center Across Selection gives the identical appearance with none of the consequences.
updated: 2026-07-12
readingTime: 5
...
Select the cells you would have merged. Right-click, Format Cells, Alignment tab, and set Horizontal to **Center Across Selection**.

The text centers across the range exactly as merging would. Visually there is no difference at all.

The cells stay separate. Sorting works, filtering works, navigation works, PivotTables work, formulas count correctly.

It has been in Excel for decades and it is buried in a dialog box, which is the entire reason people merge instead.

## Where merging is acceptable

A title cell at the top of a printed report, outside the data range, harms nothing. If it is not part of a table anyone will sort, filter or analyze, merge away.
...
Center Across Selection takes four clicks and removes the entire category of problem.
